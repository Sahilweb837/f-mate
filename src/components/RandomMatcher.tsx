...
import { Coffee, Heart, Zap, Loader2, X, MessageCircle, Video } from "lucide-react";
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: "3rem" }}>
            ...
            <div style={{ display: "flex", gap: "1rem", justifyContent: "center" }}>
              {[
                { id: "female", label: "Girls", icon: "👩" },
                { id: "male", label: "Boys", icon: "👨" },
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: "1rem",
                    borderRadius: "20px",
                    border: gender === opt.id ? "2px solid var(--pink-primary)" : "1px solid rgba(255,255,255,0.1)",
                    background: gender === opt.id ? "rgba(255,0,127,0.1)" : "rgba(255,255,255,0.03)",
          ...
          <button 
            ...
            style={{ width: "100%", padding: "1.25rem", fontSize: "1.2rem", fontWeight: 900, justifyContent: "center" }}
          >
            {matching ? <Loader2 className="animate-spin" /> : "Find My Match ☕"}
          </button>
              ...
              <div style={{ 
                ...
                <div style={{ position: "relative", height: "450px" }}>
                  ...
                  <div style={{ position: "absolute", bottom: "2rem", left: "2rem", right: "2rem" }}>
                    <h2 style={{ fontSize: "2.5rem", fontWeight: 900, marginBottom: "0.5rem" }}>{match.name}, {new Date().getFullYear() - new Date(match.date_of_birth).getFullYear()}</h2>
                    <p style={{ color: "rgba(255,255,255,0.7)", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                      <Coffee size={18} /> {match.coffee_style || "Cappuccino Lover"}
                    </p>
                  </div>
                </div>
                <div style={{ padding: "2rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                  <button className="btn-primary" style={{ width: "100%", padding: "1rem", background: "white", color: "black", fontWeight: 800 }}>
